...
export async function POST(req: NextRequest) {
  ...
  return NextResponse.json({ ...diagram, url: `${baseUrl}/d/${diagram.id}`, svg: `${baseUrl}/svg/${diagram.id}`, pdf: `${baseUrl}/pdf/${diagram.id}`, png: `${baseUrl}/png/${diagram.id}`, editor: `${baseUrl}/?id=${diagram.id}` }, { status: 201 });
}
